...
class CupcakeViewsTestCase(TestCase):
    ...
    def test_update_cupcake(self):
        with app.test_client() as client:
            ...
            self.assertEqual(data['cupcake']['image'], "http://test.com/updated_cupcake.jpg")

    def test_update_cupcake_not_found(self):
        with app.test_client() as client:
            response = client.patch("/api/cupcakes/99999", json={"flavor": "Nonexistent"})
    ...
    def test_delete_cupcake_not_found(self):
        with app.test_client() as client:
            response = client.delete("/api/cupcakes/99999")
            self.assertEqual(response.status_code, 404)
